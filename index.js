...
const { create } = require('venom-bot'); // ✨ TROQUEI A BIBLIOTECA AQUI!
const fs = require('fs');
...
// 🔒 LICENÇA
const LICENCA = {
  chave: "PRO-367745-805439-84",
  dono_autorizado: "5521991847707@c.us", // COLOQUE SEU NÚMERO
...
if (LICENCA.chave !== "PRO-367745-805439-84") {
...
// 🚀 INICIAR - SEM CHROME, SEM PUPPETEER!
create({
  session: 'bot-warlock-final',
  multidevice: true,
  logQR: true,
  disableSpins: true,
  browserWsEndpoint: null // ✨ AQUI O SEGREDO: NÃO CONECTA EM NENHUM NAVEGADOR!
})
.then(client => {
  console.log('\n✅ BOT LIGADO COM SUCESSO! 🤖');
  console.log('📷 LEIA O QR CODE ABAIXO ⬇️\n');
...
🤖 *BOT WARLOCK FINAL* v${CONFIG.versao}
━━━━━━━━━━━━━━━━━━
👑 !menudono
🛡️ !menuadm
⭐ !menugold
