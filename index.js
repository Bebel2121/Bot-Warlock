...
// 🔒 LICENÇA VÁLIDA
const LICENCA = {
  chave: 'PRO-842675-645263-38',
  dono_autorizado: '5521991847707@c.us', // COLOQUE SEU NÚMERO AQUI
  valido_ate: '2030-12-31',
  versao: '3.0-PRO'
};

// ✅ VERIFICAÇÃO DE LICENÇA
const hoje = new Date().toISOString().split('T')[0];
if (LICENCA.chave !== 'PRO-842675-645263-38' || hoje > LICENCA.valido_ate) {
...
create({
  ...
  logQR: true,
  puppeteer: false, // ✨ AQUI É O SEGREDO: NÃO USA CHROME!
  useChrome: false
})
.then(client => {
