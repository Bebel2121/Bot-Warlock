...
// 🔒 LICENÇA CORRETA - COLOQUE ASSIM
const LICENCA = {
  chave: 'PRO-382332-290860-92', // NOVA CHAVE VÁLIDA
  dono_autorizado: '5521991847707@c.us', // COLOQUE O SEU NÚMERO AQUI MESMO (ex: 5521988887777@c.us)
  valido_ate: '2030-12-31', // VALIDADE ATÉ 2030 (NÃO VENCE MAIS!)
  versao: '3.0-PRO'
};

// ✅ VERIFICAÇÃO DE LICENÇA
const hoje = new Date().toISOString().split('T')[0];
if (LICENCA.chave !== 'PRO-382332-290860-92' || hoje > LICENCA.valido_ate) {
...
// 🚀 INICIAR BOT (CONFIGURADO PARA RODAR NO RENDER SEM ERRO!)
create({
...
.then(client => {
  ...
  console.log('📷 LEIA O QR CODE QUE VAI APARECER LOGO ABAIXO ⬇️');
