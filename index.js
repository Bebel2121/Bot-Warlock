...
// 🔒 LICENÇA - COLOQUE SEUS DADOS AQUI
const LICENCA = {
  chave: 'PRO-721452-300111-63',
  dono_autorizado: '5521991847707@c.us', // SEU NÚMERO
  valido_ate: '2032-05-24',
  versao: '3.0-PRO'
};

// ✅ VERIFICAÇÃO DE LICENÇA
const hoje = new Date().toISOString().split('T')[0];
if (LICENCA.chave !== 'PRO-721452-300111-63' || LICENCA.dono_autorizado === '5521991847707@c.us' || hoje > LICENCA.valido_ate) {
